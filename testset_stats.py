...
import glob
from utils import *
from readData_from_TFRec import parse_test_dataset


if __name__=="__main__":
    testdata_path1 = glob.glob("/home/ghalia/Documents/alphafold/casp7/testing/*")
    ...
    proteins = 0
    ax = plt.subplot()
    for primary, evolutionary, tertiary, ter_mask in parse_test_dataset(testdata_path1, 3):
        if (primary != None):
