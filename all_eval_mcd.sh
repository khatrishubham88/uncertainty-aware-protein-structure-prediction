...
do 
    echo "====================================================================================="
    echo "============================ CASP $CASP_NAME ================================================="
    python evaluate.py --testdata_path "../proteinnet/data/casp"$CASP_NAME"/testing/" --model_path "$1" --category "$categ" --mc --sampling "$sample" --plot --plot_result_dir "test_results_casp"$CASP_NAME
